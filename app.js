 const materialsSection = document.getElementById('materialsSection');
    ...
    schedule: [
     ...
     "612507170": {  // Replace XXX with actual MIS number
    name: "VISHWAJEET MOHITE",  // Replace with actual student name
    branch: "Electronics and Telecommunication Engineering",
    division: "Division 2",
    schedule: [
        {
    ...
    "612507113": {  // Replace XXX with Rohan's MIS number
...
"612507XXX": {  // Replace XXX with Samarth's MIS number
...
"612507121": {  // Replace XXX with Samarth's MIS number
    name: "SAMARTH SUNIL KADAM",
    branch: "Electronics and Telecommunication Engineering",
    division: "Division 2",
    schedule: [
        ...
        function getTimetable() {
            ...
            if (timetableDatabase[mis]) {
                displayTimetable(mis, semester);
            } else {
                alert('No timetable found for MIS: ' + mis + '\n\nThis is a demo version with sample data for MIS 612507153 (SUYASH ANIL JORE).\n\nTo add your timetable, you need to update the timetableDatabase in the code with your schedule information.');
            }
        }

        function displayTimetable(mis, semester) {
